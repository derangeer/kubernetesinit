#!/bin/bash -xe
#decode
sudo -H -u ubuntu bash -c "sed -i -e 's/ //g' /opt/bastion/id_rsa.enc"
sudo -H -u ubuntu bash -c "fold -w65 /opt/bastion/id_rsa.enc | tee /opt/bastion/id_rsa"
sudo -H -u ubuntu bash -c "openssl enc -aes-256-cbc -d -a -md md5 -in /opt/bastion/id_rsa -out /home/ubuntu/.ssh/id_rsa -k $(cat key)"
#generate open key
